...
*/
alias AVAudioEngineManualRenderingBlock = AVAudioEngineManualRenderingStatus function(AVAudioFrameCount numberOfFrames, AudioBufferList *outBuffer, OSStatus* outError = null);
...
class AVAudioEngine 
{
    ...
    */
    ...
    void connect(AVAudioNode node1, AVAudioNode to, AVAudioNodeBus fromBus, AVAudioNodeBus toBus, AVAudioFormat * format = null);
    ...
    */
    ...
    void connect(AVAudioNode node, AVAudioNode to, AVAudioFormat* format = null);
    ...
    */
    ...
    void connect(AVAudioNode sourceNode, NSArray_!AVAudioConnectionPoint toConnectionPoints, AVAudioNodeBus fromBus, AVAudioFormat format = null);
    ...
    */
    ...
    void disconnectNodeInput(AVAudioNode node, AVAudioNodeBus bus);
    ...
    */
    ...
    void disconnectNodeOutput(AVAudioNode node, AVAudioNodeBus bus);
